    ...
    <form method="post" action="{{ route('admin.tags.update', $tag->id) }}">
        ...
        <div class="intro-y box p-5">
            <div>
                ...
                <input id="name" name="title" type="text" class="form-control w-full slugGenerate" data-type="tags" placeholder="Название" value="{{ $tag->title }}">
            </div>
{{--            <div class="mt-5">--}}
...
{{--            </div>--}}
            ...
            <div class="mt-6 editor_wrapper">
                @include('admin.editor.tinymce', ['content' => $tag->content])
            </div>
